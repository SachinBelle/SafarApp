...
class _UIDPageState extends State<UIDPage> {
  ...
  final List<FocusNode> _uidFocusNodes = List.generate(4, (_) => FocusNode());
                        ...
                        onPressed: () {
                          ...
                          if (uid.length == 4) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text("Please enter full 4-digit UID"),
                              ),
                            );
                          }
                        },
      ...
      bottomNavigationBar: ClipRRect(
        ...
        child: BottomNavigationBar(
          ...
          items: const [
            ...
            BottomNavigationBarItem(
              icon: Icon(Icons.location_on, size: 32, color: Colors.black),
              label: 'LOCATE',
            ),
            BottomNavigationBarItem(
